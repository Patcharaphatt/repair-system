			...
			<div class="operation-card ">
				<div class="row">
					...
					<div class="col btn-add-transection d-flex justify-content-end align-items-center ">
						<a href="form.php" class="btn-ct btn btn-success text-align-center visibility">เพิ่มยี่ห้อ</a>
					</div>
									...
									foreach($brands as $brand) {
										...
										echo "
											<tr>
												...
												<td class='elm-2'>{$brand['brandTitle']}</td>
												<td>
													...
													<div class='dropdown d-flex justify-content-end'>
														...
														<li><a class='dropdown-item' href='form.php?Id={$brand['Id']}&action=edit' class='btn btn-warning');>แก้ไข</a></li>
														<li><a id='confirm_delete' onclick='return confirmDelete()' class='dropdown-item' href='save.php?Id={$brand['Id']}&action=delete' class='btn btn-danger'>ลบรายการ</a></li>
														</ul>
													</div>
