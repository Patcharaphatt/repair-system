...
if (isset($_REQUEST['action']) == 'edit') {
    ...
    $category = $categoryObj->getCategoryById($_REQUEST['Id']); 
}
	...
	<div class="container">
				<div class="card-forms">
					...
					<div class="card-header text-white d-flex justify-content-between">
                        <h4 class="title-forms">ฟอร์ม<?php echo (isset($_REQUEST['action'])=='edit') ? "แก้ไขหมวดหมู่" : "เพิ่มหมวดหมู่";?></h4>
                    </div>
					...
					<div class="card-body ">
						<form action="save.php" method="GET">
                            ...
                            <input type="hidden" name="Id" value="<?php echo (isset($_REQUEST['action'])=='edit') ? $category['Id'] : "";?>">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg">
                                    ...
                                    <div class="form-group">
                                        <label for="category_Name">ชื่อ - หมวดหมู่</label>
                                        <input type="text" name="category_Name" id="category_Name" class="form-control my-2" maxlength="255" value="<?php echo (isset($_REQUEST['action'])=='edit') ? $category['title'] : "";?>" required>
