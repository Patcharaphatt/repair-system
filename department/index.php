			...
			<div class="operation-card ">
				<div class="row">
					...
					<div class="col btn-add-transection d-flex justify-content-end align-items-center ">
						<a href="form.php" class="btn-ct btn btn-success text-align-center visibility">เพิ่มแผนก</a>
					</div>
				...
				<table class="table table-hover align-middle" id="dataTable">
					...
					<tbody>
								...
								<?php
									...
									$accountObj = new department();
									$departments = $accountObj->getAllDepartments();
									$n=0;
									foreach($departments as $department) {
										...
										echo "
											<tr>
												...
												<td class='elm-2'>{$department['departTitle']}</td>
												<td>
													...
													<div class='dropdown d-flex justify-content-end'>
														...
														<li><a class='dropdown-item' href='form.php?Id={$department['Id']}&action=edit' class='btn btn-warning');>แก้ไข</a></li>
														<li><a id='confirm_delete' onclick='return confirmDelete()' class='dropdown-item' href='save.php?Id={$department['Id']}&action=delete' class='btn btn-danger'>ลบรายการ</a></li>
														</ul>
													</div>
